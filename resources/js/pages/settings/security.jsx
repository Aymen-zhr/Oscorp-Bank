            ...
            <div className="mx-auto max-w-2xl space-y-8">
                {canManageTwoFactor && (
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-base)] p-4">
                ...
                >
                    <div className="mb-8 flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--color-gold)]/10">
                            <Key className="h-5 w-5 text-[var(--color-gold)]" />
                        </div>
                        <div>
                            <h2 className="text-lg font-bold text-[var(--color-text-main)]">
                                Update Password
                    ...
                    <form onSubmit={updatePassword} className="space-y-6">
                        ...
                        >
                            <div className="group relative">
                                ...
                                <label
                                    ...
                                    className={labelClasses('current_password')}
                                >
                                    Current Password
                                </label>
                            </div>
                        ...
                        >
                            <motion.button
                                ...
                                whileHover={{
                                    scale: passwordForm.processing ? 1 : 1.01,
                                }}
                                whileTap={{
                                    scale: passwordForm.processing ? 1 : 0.98,
                                }}
