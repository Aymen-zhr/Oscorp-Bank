        ...
        <div className="min-h-screen w-full bg-[#0A0908] text-white font-sans flex items-center justify-center relative overflow-hidden selection:bg-[var(--color-gold)] selection:text-white">
            ...
            <div className="w-full max-w-[420px] p-8 z-10">
                <div className="flex flex-col items-center mb-10">
                    ...
                    <h1 className="text-[28px] font-bold tracking-tight mb-2">OSCORP Terminal</h1>
                    <p className="text-[13px] text-[var(--color-text-muted)] uppercase tracking-[2px]">Authorization Required</p>
                </div>
                ...
                <div className="bg-[#15141D] border border-[rgba(212,175,55,0.15)] rounded-2xl p-7 shadow-[0_0_40px_rgba(0,0,0,0.5)] relative overflow-hidden">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    name="email"
                                    value={data.email}
                                    className="w-full bg-[#1C1A27] border border-[rgba(212,175,55,0.1)] rounded-xl py-3 pl-10 pr-4 text-[14px] text-white outline-none transition-all focus:border-[var(--color-gold)] focus:shadow-[0_0_0_3px_rgba(212,175,55,0.1)] placeholder:text-white/20"
                            ...
                            <div className="flex items-center justify-between mb-2">
                                ...
                                {canResetPassword && (
                                    <Link
                                        ...
                                        className="text-[11px] text-[var(--color-gold)] hover:text-white transition-colors font-semibold"
                                    >
                                        Recover Access
                                    </Link>
                                )}
                ...
                <div className="mt-8 text-center text-[11px] text-[var(--color-text-muted)] uppercase tracking-[1.5px] opacity-60">
